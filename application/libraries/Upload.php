...
class MY_Upload {
	...
	public function data()
	{
		return array (
						...
						'file_path'			=> class_exists('SaeKV') ? $this->sae_domain.'/'.$this->upload_path : $this->upload_path,
						'full_path'			=> class_exists('SaeKV') ? $this->storage_url : $this->upload_path.$this->file_name,
